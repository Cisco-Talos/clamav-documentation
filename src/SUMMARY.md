...
- [Installing](manual/Installing.md)
    - [Unix from source](manual/Installing-from-source/Installing-from-source-Unix.md)
      - [Steps - Debian/Ubuntu](manual/Installing-from-source/Steps/Steps-Debian-Ubuntu.md)
      - [Steps - Redhat/CentOS](manual/Installing-from-source/Steps/Steps-Redhat-CentOS.md)
      - [Steps - macOS](manual/Installing-from-source/Steps/Steps-macOS.md)
