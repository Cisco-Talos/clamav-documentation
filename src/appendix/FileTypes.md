...
| ----------- | -------------------------------------------------------------------------------------------------- |
| 0           | any file                                                                                           |
| 1           | Portable Executable, both 32-bit and 64-bit                                                        |
...
| `CL_TYPE_ONENOTE`         | Microsoft OneNote Document section file                      |
...
| `CL_TYPE_PYTHON_COMPILED` | Python byte-compiled executable (.pyc)                       |
...
| `CL_TYPE_UDF`             | UDF (Universal Disk Format) Partition                        |
